...
func Catalog() []CatalogEntry {
	return []CatalogEntry{
		...
		{Path: "math/spec", Description: "Documentation: Arithmetic / Comparable / From operator specs."},
		{Path: "math/utils", Description: "Integer math primitives backing the math module."},
