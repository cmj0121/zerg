...
reject two-imports-sharing-a-last-segment E387 'is already the namespace of' at=3:2 <<'EOF'
import (
	"alt/text"
	"util/text"
)
...
# they wrote a `(` or a `.`.
reject an-import-colliding-with-a-function E387 'is already a function in this program' at=1:8 <<'EOF'
import "util/text"
