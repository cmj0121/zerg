...
//
//go:embed csrc/zergrt.h csrc/alloc.c csrc/ref.c csrc/list.c csrc/unwind.c csrc/entry.c csrc/sys.c csrc/fmt.c
...
// ConcurrencyCUnits.
var coreCUnits = []string{"alloc.c", "ref.c", "list.c", "unwind.c", "entry.c", "sys.c", "fmt.c"}
